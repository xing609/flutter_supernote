...
class DBManager {
  /// 数据库名
  final String _dbName = "supernoteDataBase.db";
  ...
  Future<Database> _initDB() async {
    // Directory directory = await getApplicationDocumentsDirectory();//存储在app_flutter目录下
    // String path = join(directory.path, _dbName);

    String databasesPath = await getDatabasesPath();//存储在database目录下
